...
"""
 Extracting linear transformations for virtual angle 4
"""
R07 = matrix(T07[:3,:3])
P07 = matrix(T07[:3,3])
...
phi = math.acos((d_se**2 + (mag(P26))**2 - d_ew**2) / ( 2*d_se*(mag(P26))**2 ))
#print(phi)
...
# converting "0"  to  "0.00000001" to prevent division by zero error
if mod_real_sew == 0:
