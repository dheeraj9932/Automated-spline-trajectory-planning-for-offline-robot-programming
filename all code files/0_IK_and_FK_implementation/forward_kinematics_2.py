...
df = pd.read_csv("points_and_joint_angles_rads_4.csv")
df2 = df[["a","b","c", "d","e","f","g","h","i","j"]]
every_row = df2.iloc[0::1]
...
for i in range(every_row_np.shape[0]):
    ...
    theta = np.array([(angles[0]), (angles[1]), (angles[2]), (angles[3]), (angles[4]), (angles[5]), (angles[6])])
