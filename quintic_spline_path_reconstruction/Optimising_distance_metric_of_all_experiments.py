...
def similarity_check(variable):
    ...
    for i in range(len(experiments_list)):
        ...
        if (l >=minimum_spline_points) and (i!=4) and (i!=12) and (i!=13):
            exp_no = i
            ...
            datalog_temp = datalog[datalog_start:datalog_end, :]
            ...
            control_points = []
            final_trajectory = []
            for m in range(len(spline_points)): #0-5
                # print(m,'m')
                if m < (len(spline_points) - 1):
                    # print(aa,'aa')
            ...
            average_distances.append(dtw)
    no_nan_average_distances = [x for x in average_distances if math.isnan(x) == False]
    average_metric = sum(no_nan_average_distances)/len(no_nan_average_distances)
...
minimum_spline_points = 5
# print("Current Time =", current_time)
# print(similarity_check([0,0,0,0]))
# print("Current Time =", current_time)
print('\n'+"end of one demo iteration for time estimation"+'\n')
#
print("Current Time =", current_time)
result = differential_evolution(similarity_check, bounds, popsize = 10, maxiter= 1)
