...
def graph_plot(generated, datalog):
    ...
    ax.scatter(p1[0], p1[1], p1[2], c='red', linewidths=10)
    ...
    # ax.scatter(p9[0], p9[1], p9[2], c='black', linewidths=10)
    ax.scatter(p6[0], p6[1], p6[2], c='black', linewidths=10)
    ax.scatter(p7[0], p7[1], p7[2], c='black', linewidths=10)
    ax.scatter(p8[0], p8[1], p8[2], c='black', linewidths=10)
...
#########################################################################
# result = differential_evolution(similarity_check, bounds, maxiter=10)
# print(result.x)
# print(result.fun)
########################################################################
...
variables1 = [0.49235465, 0.13854857	,0.04462645	,-4.79506959 ] # weighted averaged
opt  = np.genfromtxt('multisegment_optimised_control_variables.csv', delimiter=',')
# print(opt)
variables2 = opt[exp_no]
# variables2 = [ 0.51771419	,0.21188888	,0.11186375	,-4.71061226 ] # respective original
print(similarity_check_for_graph_plot(variables1),', ', similarity_check_for_graph_plot(variables2))
